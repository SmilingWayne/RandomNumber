...
<div class = "Board">
<div style = "flex: float; margin : auto">
    <el-button type = "primary"  @click = "init"> Restart </el-button>

    </div>

    <h1>💣 :{{ 10 - countFlags }} | 🚩: {{ countFlags }}</h1>
    <h2>⏰ :{{ seconds }}</h2>
    <canvas id = "canvas" ref = "canvas05" v-bind:width = "canvasWidth" v-bind:height = "canvasHeight">
    </canvas>
...
export default {
    ...
    data() {
        return {
            ...
            g_arr : [], 
            g_obj : {}, // record status
            g_color : { block : '#369' , open :  '#bbb', mine : "#333", hover : '#ggg', highlight: "#89f", warning: "#8E2323", supHightLight: "#00BFFF"}, // modify color
            f_color : ["#bbb", "#0000FF", "#2F4F2F", "#FF0000" , "#6B238E", "#FF7F00", "#4E2F2F", "#CC3299", "#5C3317" ],
            row : 9,
            col : 9,
            mines : 10,
